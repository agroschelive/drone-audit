...
<head>
  <meta charset="utf-8">
  <title>Drone Audit - Relatório</title>
  <style>
...
<body>
  ...
  <div class="warning">
    Este relatório é auxiliar e experimental. Ele não substitui interpretação profissional, validação em campo ou responsabilidade técnica.
  </div>
