...
The sanitizer is conservative, but you must inspect sanitized output before publishing. Sanitization does not automatically guarantee anonymity: real coordinates, route shapes, names, serials, timestamps, and internal identifiers must not be published. Synthetic coordinates generated by the tool are not real coordinates.
